...
with st.form("captura"):
    ...
    contrato = st.radio("Defina o valor bruto do Contrato", options=('3 bilhões', '4 bilhões', '5 bilhões'))
...
if button:
    ...
    if (dif_fla + dif_cor) > 0:
        ...
        cfc_gm = 0.03380*(dif_fla + dif_cor)
...
##########################################################################
    ...
    if clube_3 == "América":
        ...
        clube_gm = cfc_gm
        clube_gm_fla = cfc_gm_fla
        clube_gm_cor = cfc_gm_cor
