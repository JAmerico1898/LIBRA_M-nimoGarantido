...
if button:
    ...
    if contrato == "3 bilhões":
        ...
        audiência_libra_1 = 0.3*3000*0.1705555
        ...
        audiência_libra_2 = 0.3*3000*0.1345555
    ...
    #faturamento_libra_1 = (round(faturamento_libra_1[0], 0)).astype(int)
    ...
    #faturamento_libra_2 = (round(faturamento_libra_2[0], 0))
    ...
    #faturamento_libra_3 = (round(faturamento_libra_3[0], 0)).astype(int)
    ...
    #faturamento_lff_1 = (round(faturamento_lff_1[0], 0)).astype(int)
    ...
    #faturamento_lff_2 = (round(faturamento_lff_2[0], 0)).astype(int)
    ...
    #faturamento_lff_3 = (round(faturamento_lff_3[0], 0)).astype(int)

    #####################################################################################
    #####################################################################################
    #Cálculo da Recomposição da GM
    if (fla_gm - faturamento_libra_1) > 0:
        dif_fla = fla_gm - faturamento_libra_1
        faturamento_libra_1 = faturamento_libra_1 + dif_fla  
    else:
        dif_fla = 0
        faturamento_libra_1 = faturamento_libra_1

    if (cor_gm - faturamento_libra_2) > 0:
        dif_cor = cor_gm - faturamento_libra_2
        faturamento_libra_2 = faturamento_libra_2 + dif_cor
    else:
        dif_cor = 0
        faturamento_libra_2 = faturamento_libra_2


    #Cáculo da Contribuição de cada clube
    ...
    markdown_amount_2 = f"<div style='text-align:center; font-size:{fontsize}px'>R$ {clube_gm:.1f} milhões</div>"
    
    col1, col2 = st.columns(2)
    with col1:
        st.markdown("<h4 style='text-align: center;'>Contribuição dos 18 Clubes para o Mínimo Garantido de FLA & COR</b></h4>", unsafe_allow_html=True)
        st.markdown(markdown_amount, unsafe_allow_html=True)
    with col2:
        st.markdown("<h4 style='text-align: center;'>Contribuição do SEU CLUBE para o Mínimo Garantido de FLA & COR</b></h4>", unsafe_allow_html=True)
    ...
    faturamento_2 = (faturamento_libra_2, faturamento_lff_2)
